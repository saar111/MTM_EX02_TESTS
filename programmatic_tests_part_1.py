...
class Tests(object):
    ...
    def testYoungStudentsNegativeKReturnsMinus1():
        ...
        assert runYoungStudentsWithInputName(input_file_name, -1) == -1, "(Wrong value was: " + str(runYoungStudentsWithInputName(input_file_name, -1)) + ")"
        assert not os.path.exists(output_file_path), "File should not be created for negative k"

        assert runYoungStudentsWithInputName(input_file_name, 0) == -1, "(Wrong value was: " + str(runYoungStudentsWithInputName(input_file_name, 0)) + ")"
        assert not os.path.exists(output_file_path), "File should not be created for negative k"
    ...
    def testYoungStudentsBasicUsageReturnsCorrectNumber():
        ...
        assert runYoungStudentsWithInputName(input_file_name, 3) == 2, "(Wrong value was: " + str(runYoungStudentsWithInputName(input_file_name, 3)) + ")"
        assert runYoungStudentsWithInputName(input_file_name, 2) == 2, "(Wrong value was: " + str(runYoungStudentsWithInputName(input_file_name, 2)) + ")"
        assert runYoungStudentsWithInputName(input_file_name, 8) == 2, "(Wrong value was: " + str(runYoungStudentsWithInputName(input_file_name, 8)) + ")"
        assert runYoungStudentsWithInputName(input_file_name, 1) == 1, "(Wrong value was: " + str(runYoungStudentsWithInputName(input_file_name, 1)) + ")"

    @staticmethod
    def testYoungStudentsNoYoungestReturns0():
        input_file_name = "3.1.2.1_young_students_no_students_valid_k_1.txt"
        assert runYoungStudentsWithInputName(input_file_name, 1) == 0, "(Wrong value was: " + str(runYoungStudentsWithInputName(input_file_name, 1)) + ")"
    ...
    def testYoungStudentsManyWrongStudentsAndGenerallyShit():
        ...
        assert runYoungStudentsWithInputName(input_file_name, 10000) == 20, "(Wrong value was: " + str(runYoungStudentsWithInputName(input_file_name, 10000)) + ")"
        assert runYoungStudentsWithInputName(input_file_name, 17) == 17, "(Wrong value was: " + str(runYoungStudentsWithInputName(input_file_name, 17)) + ")"
        assert runYoungStudentsWithInputName(input_file_name, 10) == 10, "(Wrong value was: " + str(runYoungStudentsWithInputName(input_file_name, 10)) + ")"

    @staticmethod
    def testCorrectAgeAvgBasicUsage():
        assert runCorrectAgeAvgWithInputName("3.1.2.2_correct_avg_basic_1.txt", 1) == (20 + 23) / 2.0, "(Wrong value was: " + str(runCorrectAgeAvgWithInputName("3.1.2.2_correct_avg_basic_1.txt", 1)) + ")"
        assert runCorrectAgeAvgWithInputName("3.1.2.2_correct_avg_basic_1.txt", 2) == (19 + 17) / 2.0, "(Wrong value was: " + str(runCorrectAgeAvgWithInputName("3.1.2.2_correct_avg_basic_1.txt", 2)) + ")"
        assert runCorrectAgeAvgWithInputName("3.1.2.2_correct_avg_basic_1.txt", 3) == 18, "(Wrong value was: " + str(runCorrectAgeAvgWithInputName("3.1.2.2_correct_avg_basic_1.txt", 3)) + ")"
        assert runCorrectAgeAvgWithInputName("3.1.2.2_correct_avg_basic_1.txt", 4) == 16, "(Wrong value was: " + str(runCorrectAgeAvgWithInputName("3.1.2.2_correct_avg_basic_1.txt", 4)) + ")"

    @staticmethod
    def testCorrectAgeAvgSemestersWithNoStudentsReturns0():
        input_ = "3.1.2.2_correct_avg_basic_1.txt"
        assert runCorrectAgeAvgWithInputName("3.1.2.2_correct_avg_basic_1.txt", 5) == 0, "(Wrong value was: " + str(runCorrectAgeAvgWithInputName("3.1.2.2_correct_avg_basic_1.txt", 5)) + ")"
        assert runCorrectAgeAvgWithInputName("3.1.2.2_correct_avg_basic_1.txt", 6) == 0, "(Wrong value was: " + str(runCorrectAgeAvgWithInputName("3.1.2.2_correct_avg_basic_1.txt", 6)) + ")"
        assert runCorrectAgeAvgWithInputName("3.1.2.2_correct_avg_basic_1.txt", 9) == 0, "(Wrong value was: " + str(runCorrectAgeAvgWithInputName("3.1.2.2_correct_avg_basic_1.txt", 9)) + ")"

    @staticmethod
    def testCorrectAgeAvgInvalidSemesterReturnsMinus1():
        assert runCorrectAgeAvgWithInputName("3.1.2.2_correct_avg_basic_1.txt", -1) == -1, "(Wrong value was: " + str(runCorrectAgeAvgWithInputName("3.1.2.2_correct_avg_basic_1.txt", -1)) + ")"
        assert runCorrectAgeAvgWithInputName("3.1.2.2_correct_avg_basic_1.txt", 0) == -1, "(Wrong value was: " + str(runCorrectAgeAvgWithInputName("3.1.2.2_correct_avg_basic_1.txt", 0)) + ")"
        assert runCorrectAgeAvgWithInputName("3.1.2.2_correct_avg_basic_1.txt", -6) == -1, "(Wrong value was: " + str(runCorrectAgeAvgWithInputName("3.1.2.2_correct_avg_basic_1.txt", -6)) + ")"
